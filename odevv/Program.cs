...
namespace odevv
{
    ...
    class Program
    {
        ...
        
        {
            ...
            public static void Main()
            {
                ...
                if (!File.Exists(path))
                {
            string[] createText = { "port:443", "foreginAddress:", "55.143.25.2" };
            string[] appedText = { "port:482", "foreginAddress:", "55.143.25.1" };
            string[] appText = { "port:1002", "foreginAddress:", "55.143.25.4" };
    ...
    [
 {
  port:443, foreginAddress: "55.143.25.2"
 },
 {
port: 482,
  foreginAddress: "55.143.25.1"
 },
 {
port: 1002,
  foreginAddress: "55.143.25.4"
 }
]
